...
class UserProfileManager(BaseUserManager):
    ...
    def create_user(self, username, email, name=None, phone=None, address=None, account_type=None, photo=None,
                    school=None, teacher=None, parent=None, classes=None, section=None, librarian=None, password=None):
        ...
        user = self.model(username=username, email=email, name=name, phone=phone, address=address,
                          account_type=account_type, photo=photo, school=school, teacher=teacher, parent=parent,
                          classes=classes, section=section, librarian=librarian)
